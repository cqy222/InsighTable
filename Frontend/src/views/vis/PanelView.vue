...
export default {
  ...
  methods: {
    ...
    Apply2Vis() {
      ...
      // var insight_type = "test";
      // console.log("Apply2Vis", this.visData);
      // console.log("Apply2Vis", this.markJson);
      // console.log("Apply2Vis", this.encodingJson);
      // this.$bus.$emit("RLPanel-add-user-icon", insight_type);
    },
    ApplyMark(data) {
      this.markJson = data;
      this.EmitVegaConfig();
