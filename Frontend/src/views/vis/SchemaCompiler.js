...
export let markConf = {
    ...
    line: function (df_strokeWidth, df_color, df_interpolate) {
        ...
        this.properties.strokeWidth = new confTemplate.width('stroke width', 3, 10, undefined);
    ...
    point: function (df_size, df_shape) {
        this.properties = {};
        this.properties.size = new confTemplate.width('size', 1, 500, 30);
        this.properties.strokeWidth = new confTemplate.width('stroke Width', 1, 20, 2);
