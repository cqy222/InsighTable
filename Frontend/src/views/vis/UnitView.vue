        ...
        ><el-col :span="15">
          <div>
            ...
            <div class="recommend-box" >
              <label
                class="property-text"
                style="font-size: 5px; margin-top: 10px;width:35px"
                >type:</label
              >
              <el-radio-group v-model="typeSelectValue" size="mini" style="margin-top: 8px"
                ><el-radio-button
            ...
            <div class="recommend-box">
              ...
              <div class="slider">
                <el-slider
                  v-model="prioritySliderValue" style="margin-top: 7px"
                  range
                  show-stops
                  :min="0"
                  :max="2"
...
export default {
  name: "UnitView",
  components: {},
  props: ["visData_arr", "figID", "recommendValue"],
  data() {
    return {
      shapes: [
  ...
  methods: {
    ...
    Apply2Vis() {
      ...
      if (!!this.figID && this.figID !== "") {
        // console.log("RerenderCanvas-Apply2Vis");
        ...
        console.log("Apply2VisApply2Vis", this.VisDB);
        console.log("Apply2VisApply2Vis2", this.visData);
      } else {
        let groupId;
        let ID;
        for (let i = 0; i < this.visData.length; i++) {
          ...
          if (ID) {
            ...
            // console.error("AddGroupMember-Apply2Vis", groupId, ID);
            groupId = this.VisDB.AddGroupMember(groupId, ID);
          }
        }
        this.$bus.$emit("VisView-change-figID", ID);
        // this.figID = ID;
        console.log("Apply2VisApply2Viselse0", this.selectedArea, this.recommendData);
        console.log("Apply2VisApply2Viselse1", this.VisDB);
        console.log("Apply2VisApply2Viselse2", this.visData);
        console.log("Apply2VisApply2Viselse3", ID, groupId);
        this.$bus.$emit("TableView-add-user-icon");
