...
<script>
  ...
  export default {
    ...
    beforeMount: function() {
      if (this.datasetDialogKey == 1) {  // 将要显示的是RL结果弹窗 
    ...
    methods: {
        ...
        confirmSelection: function() {
            ...
            if (this.tempSelection != null) {
              ...
              if (this.datasetDialogKey == 1) { // 选择rl数据
            ...
            this.$bus.$emit('SelectRL', this.selectedRLDataName)
        },
        getFile: function() {
