...
class EvaENV(object):
    def __init__(self, tuta_tools):
        ...
        self.data_name = 'Console'# Console Income TransT
        self.use_gnn = True
        ...
        np.random.seed(0)
        self.seeds_len = 10000
        self.random_seeds = np.random.randint(0, 1000000000, self.seeds_len)


            # self.seeds_len = 100000
            # self.random_seeds = np.random.randint(0, 1000000, self.seeds_len)
    ...
    def reset(self):
        ...
        np.random.seed()
        np.random.seed(self.random_seeds[np.random.randint(self.seeds_len)])
        nums = np.random.randn(self.table.shape[0], self.table.shape[1]) * 100_000
